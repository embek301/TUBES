...
Route::get('download-file/{jajanId}', [JajanController::class, 'downloadFile'])->name('jajan.downloadFile');

Route::get('getJajan', [JajanController::class, 'getData'])->name('jajan.getData');

Route::get('exportExcel', [JajanController::class, 'exportExcel'])->name('jajan.exportExcel');

Route::get('exportPdf', [JajanController::class, 'exportPdf'])->name('jajan.exportPdf');